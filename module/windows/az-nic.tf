...
resource "azurerm_network_interface" "nic" {
  name                          = var.nic_name == null ? "${var.name}_nic" : var.nic_name
  ...
  dynamic "ip_configuration" {
    ...
    content {
      name                          = ip_configuration.value.ipconfig_name == null ? "${var.name}_ipconfig" : ip_configuration.value.ipconfig_name
